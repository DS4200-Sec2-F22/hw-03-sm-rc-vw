function v1button1Clicked() {
	...
	v1button1Div.style.display = 'none';

	let text = document.getElementById('marks1');
...
function v1button2Clicked() {
	...
	v1button2Div.style.display = 'none';

	let text = document.getElementById('cmap1');
	text.style.display = 'inline';
}

function v2button1Clicked() {
	let v2button1Div = document.getElementById("vis2button1");
	v2button1Div.style.display = 'none';

	let text = document.getElementById('marks2');
	text.style.display = 'inline';
}

function v2button2Clicked() {
	let v2button2Div = document.getElementById("vis2button2");
	v2button2Div.style.display = 'none';
